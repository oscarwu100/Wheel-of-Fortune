...
while number!= 4:
    ...
    if number== 1:
        ...
        if len(consonant_used)== 21:
            ...
            print('The wheel landed on '+ str(spin_space[r])+ '.', end= '')
    
            while 1:
                wheel_pick= input('Pick a consonant: ')
                if wheel_pick.upper() in consonant_used:
                    print('The letter', wheel_pick.upper(), 'has already been used.', end= '')
                elif wheel_pick.upper() in vowel_list:
                    print('Vowels must be purchased.', end= '')
                    ...
                    print('Please enter exactly one character.', end= '')
                else:
                    print('The character', wheel_pick, 'is not a letter.', end= '')
        ...
        if money< 250:
            ...
            while 1:
                    ...
                    if wheel_pick.upper() in vowel_used:
                        ...
                        print('Consonants cannot be purchased.', end= '')
                    elif wheel_pick.upper() in vowel_list:
